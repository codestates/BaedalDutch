        ...
        if (!post) {
          return (
            <PostNoneDiv>
              ...
              <PostNone>지도를 더 확대해주세요</PostNone>
            </PostNoneDiv>
          );
          ...
          return (
            <PostNoneDiv>
              ...
              <PostNone>배달 목록이 없어요</PostNone>
            </PostNoneDiv>
          );
        } else if (click) {
          return <PostDetail click={click} setClick={setClick} />;
        } else if (!click) {
          return post.map((li, i) => {
            return !loading ? (
              <Wrapper key={i} onClick={() => handlePostList(li.id)}>
                ...
                <PostListTextWrapper>
                  ...
                  <PostTextDiv>
                    ...
                    <PostListTextRight>
                      {' '}
                      {li.content_count} / {li.recruitment_personnel}명{' '}
                    </PostListTextRight>
                  </PostTextDiv>
                  <PostTextDiv>
                  ...
                  <PostTextDiv>
                    ...
                    <PostListTextRight>
                      {' '}
                      {parseInt(li.delivery_fee / li.recruitment_personnel)} 원
                    </PostListTextRight>
                  </PostTextDiv>
                </PostListTextWrapper>
              </Wrapper>
