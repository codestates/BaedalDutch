...
import {
  ...
  editPostClosed,
  editPostRecruitment,
  editPostCancelRecruitment,
} from '../redux/postList/action';
...
function PostDetail({ click, setClick }) {
  ...
  const handlePostRecruitment = () => {
    Swal.fire({
      ...
      if (result.value) {
        dispatch(
          editPostRecruitment(list.id, list.restaurant_name, userInfo.nickname, list.category_food),
        );
        window.location.replace('/Main');
      } else {
      }
    ...
    <PostMainWrapper>
      <PostWrapper>
        <PostIconWrapper>
          ...
          {!userInfo ? null : userInfo.id === listUserId && !editText ? (
            <PostUpdateDelete>
          ...
          <>
            <WrapperDiv>
              <Wrapper>
                ...
                <PostListTextWrapper>
                  ...
                  <PostTextDiv>
                    ...
                    <PostListTextRight>
                      {' '}
                      {list.content_count} / {list.recruitment_personnel}명{' '}
                    </PostListTextRight>
                  </PostTextDiv>
                  <PostTextDiv>
                  ...
                  <PostTextDiv>
                    ...
                    <PostListTextRight>
                      {' '}
                      {parseInt(list.delivery_fee / list.recruitment_personnel)} 원
                    </PostListTextRight>
                  </PostTextDiv>
                </PostListTextWrapper>
              </Wrapper>
              ...
              <div>
                ...
                <PostListDetailText>{list.body}</PostListDetailText>
              </div>
            </WrapperDiv>
          </>
        ) : (
